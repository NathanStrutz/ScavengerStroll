  ...
  data: function () {
    return {
      items: [
        ...
        { name: "Trash can", image: "", completed: false },
        ...
        { name: "Sprinkler", image: "", completed: false },
        { name: "Map sign", image: "IMG_5544.JPG", completed: false },
        { name: "Grill", image: "", completed: false },
        { name: "Magnolia shelter", image: "", completed: false },
        { name: "Picnic table", image: "", completed: false },
...
const NatureScavengerItems = Vue.component("NatureScavengerItems", {
  ...
  data: function () {
    return {
      items: [
        { name: "Bird (cardinal, falcon, etc.)", image: "", completed: false },
        ...
        { name: "Reptile (turtle, alligator, etc.)", image: "", completed: false },
        { name: "Mammal (deer, raccoon, etc.)", completed: false },
